...
public class ControllerJogada {
    ...
    public Jogada calculaResultado(int jogadaHumano){
        ...
        if((jogadaHumano == 0 && jogadaPC == 1) || (jogadaHumano == 1 && jogadaPC == 2) || (jogadaHumano == 2 && jogadaPC == 0)){
            jogada.setDescricaoJogada("Você perdeu :/");
        }else if((jogadaHumano == 0 && jogadaPC == 2) || (jogadaHumano == 1 && jogadaPC == 0) || (jogadaHumano == 2 && jogadaPC == 1)){
